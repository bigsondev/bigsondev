...
authorLink: https://unsplash.com/photos/-1_RZL8BGBM?utm_source=unsplash&utm_medium=referral&utm_content=creditShareLink
tags: react
difficulty: 2
---
...
export const listData = [
  ...
  <Text>
    It's also scalable and will work with any amount of dialog/modal/popup
    components.
  </Text>,
  <Text>
    Whenever you notice a duplicated code - think of a hook but just don't
    refactor too early, try to balance it.
  </Text>,
];
