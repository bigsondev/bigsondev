...
export const postListData = [
  ...
  <Text size="preNormal">
    ...
    <Link href="https://iterm2.com/" size="preNormal">
      iTerm
    </Link>{' '}
    and{' '}
    <Link href="https://code.visualstudio.com/" size="preNormal">
      VSCode.
    </Link>
  </Text>,
  <Text size="preNormal">
    Create project e.g. through{' '}
    <Link href="https://create-react-app.dev/" size="preNormal">
      CRA
    </Link>{' '}
    and connect it to{' '}
    <Link href="https://git-scm.com/" size="preNormal">
      git
    </Link>
    .
  </Text>,
