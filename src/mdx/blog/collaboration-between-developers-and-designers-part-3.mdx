---
title: Collaboration Between Developers And Designers - Part 3
...
path: /blog/collaboration-between-developers-and-designers-part-3/
hasCheatSheet: false
hasTodoList: false
series: true
readTime: 4
...
>
  ...
  <Paragraph>
    Join me on{' '}
    <GatsbyLink to="/blog/collaboration-between-developers-and-designers-part-3/#bigsondev-slack">
      Slack
    </GatsbyLink>{' '}
    or post/share on some{' '}
    <GatsbyLink to="/blog/collaboration-between-developers-and-designers-part-3/#bigsondev-spread-the-word">
      socials
    </GatsbyLink>{' '}
