...
import { Text, Title, Paragraph, Link, Todo, Post } from '~components';

<Post title={props.pageContext.frontmatter.title} desc={props.pageContext.frontmatter.desc} date={props.pageContext.frontmatter.date} readTime={props.pageContext.frontmatter.readTime} showSubtitle>
