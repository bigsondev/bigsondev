...
export const homeworkData = [
  <Text delete>Read the article.</Text>,
  ...
  'Write down the interview cheatsheet (questions you will ask, answers to questions you expect from the recruiter) one day before',
  'Do a Mock Interview',
];
...
>
  ...
  <Paragraph>
    ...
    where we can just code and be happy are gone. Soft-skills are sharpening as
    a crucial ability in the IT world, especially Frontend. Co-op with
    Designers, Product Owners, clients, brainstorming with the team are just a
    few terms which require excellent communication skills.
  </Paragraph>
  ...
  <Paragraph>
    The above questions are a bare minimum you should research. If it's
  ...
  <Paragraph lastParagraph>
    ...
    <Text strong>open minded</Text>, <Text strong>likes brainstorming</Text>{' '}
    etc.
  </Paragraph>
  ...
  <Paragraph>
    ...
    <Text strong>Hi</Text> at the start can change first impression
    diametrically.
  </Paragraph>
  <Paragraph lastParagraph>
    There is a{' '}
  ...
  <Paragraph>
    ...
    it's a muscle which needs some help from you to grow. Try out katas on{' '}
  ...
  <Paragraph lastParagraph>
    If interview is fully online, prepare microphone, camera, internet
    ...
    with live sharing enabled. Otherwise ask a HR person who contacted you if
  ...
  <Paragraph>
    ...
    will help you to remember. It's quite common to forget an important things
    when you're under the pressure or stressed. Overcome it.
  </Paragraph>
  <Paragraph>
  ...
  <Paragraph>
    ...
    <Link href="https://www.pramp.com/#/">Services</Link> like this exists,
    there are plenty of them on the Web, but they're usually very general and
    have hardcoded plan which won't prepare you well enough.
  </Paragraph>
  <Paragraph>
    It appears I offer such services.{' '}
    <Text strong>
      I'll first treat you individually and get to know what is your skill
      level and experience
    </Text>
    . After that we'll have a <Link href="#">Mock Interview</Link> targeted at
    concrete position such as <Text strong>Junior</Text>, <Text strong>
      Regular
    </Text> or <Text strong>Senior</Text>. When I was being interviewed, I received
    feedback rarely and it didn't motivate me.
  </Paragraph>
  <Paragraph>
    After the Mock Interview with me, I'll send you a{' '}
    <Text strong>robust feedback</Text> which will help with the future learning
    and simplify understanding where you're in your IT career. Sometimes we
    delay the raise, because of being unsure about our skills.
  </Paragraph>
  ...
  <Paragraph>
    <Text strong>Our brains are mostly made out of water</Text>, drink often,
    not all at once, but around 8 glasses per day. Use{' '}
  ...
  <Paragraph lastParagraph>
    ...
    the recruitment process. Mention some hobby, technology or anything what
