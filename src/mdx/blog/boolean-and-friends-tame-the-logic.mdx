...
path: /blog/boolean-and-friends-tame-the-logic/
hasCheatSheet: false
hasTodoList: false
series: false
readTime: 7
...
export const orOperatorExample = `
...
export const falsyValuesExample = `
...
>
  ...
  <SyntaxHighlighter showCopy>{booleanPrimitiveExample}</SyntaxHighlighter>
  <Paragraph>
  ...
  <SyntaxHighlighter showCopy>{booleanWrappingObjectExample}</SyntaxHighlighter>
  ...
  <SyntaxHighlighter showCopy>{andOperatorExample}</SyntaxHighlighter>
  <Paragraph>
  ...
  <SyntaxHighlighter showCopy>{orOperatorExample}</SyntaxHighlighter>
  <Paragraph>
  ...
  <SyntaxHighlighter showCopy>{notOperatorExample}</SyntaxHighlighter>
  <Paragraph lastParagraph>
  ...
  <SyntaxHighlighter showCopy>{falsyValuesExample}</SyntaxHighlighter>
  <Paragraph>
  ...
  <SyntaxHighlighter showCopy>{falsyValuesConditionsExample}</SyntaxHighlighter>
  <Paragraph>
  ...
  <SyntaxHighlighter showCopy>{conversionExample}</SyntaxHighlighter>
  <Paragraph lastParagraph>
  ...
  <SyntaxHighlighter showCopy>{examplesExample}</SyntaxHighlighter>
  <Paragraph lastParagraph></Paragraph>
